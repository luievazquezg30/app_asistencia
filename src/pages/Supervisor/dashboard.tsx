...
const Dashboard: React.FC = () => {
  ...
  const downloadPDF = () => {
    try {
      ...
      // Columnas actualizadas incluyendo Colaborador y Flotilla
      const columns = ["Fecha", "Colaborador", "Flotilla", "Entrada", "Salida", "Estado"];
      
      // Mapeo uniendo los datos de asistencia con la información de su respectivo empleado
      ...
      // Nombre de archivo dinámico basado en el tipo de reporte
